 ...
 * Creates a function named wxr_get_<component_type>_<field_name> that retrieves
 ...
 * Creates a function named wxr_set_<component_type>_<field_name> that updates
 ...
 * This is a convenience macro that combines WXR_BASIC_GETTER and
 * WXR_BASIC_SETTER.
 * @param component_type The type name of the component struct
 ...
 * Creates a function named wxr_get_<component_type>_<field_name> that retrieves
 * a string field value. This is a specialized version of WXR_BASIC_GETTER for
 * string types (char*).
 * @param component_type The type name of the component struct
 ...
 * and allocating memory for the new string using wxr_copy_char_ptr.
 * @param component_type The type name of the component struct
 ...
 * This is a convenience macro that combines WXR_STRING_GETTER and
 * WXR_STRING_SETTER for string fields that require special memory management.
 * @param component_type The type name of the component struct
 ...
 * Creates a function named wxr_serialize_<component_type>_<field_name> that
 ...
 * Creates a function named wxr_deserialize_<component_type>_<field_name> that
 ...
 * This is a convenience macro that combines WXR_BASIC_SERIALIZE and
 * WXR_BASIC_DESERIALIZE for non-string fields.
 * @param component_type The type name of the component struct
 ...
 * string and allocating memory for the new string using wxr_copy_char_ptr.
 * @param component_type The type name of the component struct
 ...
 * This is a convenience macro that combines WXR_STRING_SERIALIZE and
 * WXR_STRING_DESERIALIZE for string fields that require special memory
 * management.
 * @param component_type The type name of the component struct
 ...
 * Creates a WXR_Component_Field and adds it to the provided schema. This is
 ...
 * name following the naming convention: wxr_<action>_<component_type>_<name>.
