...
/// Creator function for a component. It is a constructor for the component. It
/// allocates the component created onto the heap and then returns the raw
/// pointer in form of a null pointer. The creator function should not fail.
///
/// # Safety
///
/// There are no immediate preconditions for the function to be safe. The
/// function might be some function defined in some foreign language and is
/// therefore inherently unsafe.
pub type Creator = unsafe extern "C" fn() -> *mut c_void;

/// Destroyer function for a component. It is basically a destructor call to the
/// component. The destroyer function should not fail.
/// It takes the pointer to the object created by the [`Creator`]
/// and destroys the object.
///
/// # Safety
///
/// The function requires a pointer that was created by the corresponding
/// creator function of the component.
